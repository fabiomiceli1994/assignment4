...
REPORTExtra=u1894945-assignment4.aux u1894945-assignment4.log u1894945-assignment4.bbl u1894945-assignment4.blg u1894945-assignment4.out u1894945-assignment4.synctex.gz u1894945-assignment4.toc
...
$(RESULTS): $(PROGRAM)
	...
	./$(PROGRAM) 16 1.0 0 0.001
	./$(PROGRAM) 16 0.1 0 0.001
	./$(PROGRAM) 16 1.0 1 0.001
	./$(PROGRAM) 16 0.1 1 0.001
	./$(PROGRAM) 16 1.0 2 0.001
	...
	@echo --------------------------------------------- BE ---------------------------------------------------------------------
	./$(PROGRAM) 16 1.0 1 0.001
	./$(PROGRAM) 25 1.0 1 0.001
	@echo --------------------------------------------- Heun3 ------------------------------------------------------------------
	./$(PROGRAM) 16 1.0 2 0.001
	./$(PROGRAM) 25 1.0 2 0.001
